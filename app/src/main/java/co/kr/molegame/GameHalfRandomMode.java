...
public class GameHalfRandomMode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_half_random_mode);
...
//        setCamera();
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        plannedIdList.add((splitScreenCnt-1) * splitScreenCnt);
        ...
        public void onMessage(String message) {
            ...
            try {
                ...
                if(gameTimeSec == -1){
                    ...
                    Intent intent = new Intent(GameHalfRandomMode.this, MoleGameResult.class);
